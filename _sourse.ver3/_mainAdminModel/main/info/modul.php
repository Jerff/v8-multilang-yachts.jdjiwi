...
class main_info_modul extends driver_modul_edit {
	...
	protected function init() {
		...
		switch($this->getId()) {
			...
			case 'contact':
				$isForm['isContact'] = $isForm['isContent'] = $isForm['isTitle'] = true;
				break;

			case 'contact/main':
				$isForm['isContact'] = $isForm['isYandexMap'] = true;
				break;
			...
			case 'main':
                $isForm['isHeader'] = $isForm['isFooter'] = $isForm['isContact'] = $isForm['isContent'] = $isForm['isTitle'] = true;
				break;
		...
		if($isForm['isContact']) {
//			$form->add('phone',	    new cmfFormTextarea(array('max'=>255, '!empty')));
////			$form->add('skype',	    new cmfFormText(array('max'=>255, '!empty')));
////			$form->add('icq',	    new cmfFormText(array('max'=>255, '!empty')));
//			$form->add('adress',	new cmfFormTextarea(array('max'=>500, '!empty')));
		}
