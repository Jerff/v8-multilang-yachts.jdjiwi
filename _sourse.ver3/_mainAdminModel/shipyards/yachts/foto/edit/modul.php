...
class shipyards_yachts_foto_edit_modul extends driver_modul_gallery_list_edit {

	protected function init() {
		parent::init();

		$this->setDb('shipyards_yachts_foto_edit_db');
		...
		$this->setPath(cmfPathShipyardsYachtsFoto);
